...
const rawChannels = [
    ...
    { id: 'tnt-novelas', name: 'TNT Novelas', url: 'https://canais.fazoeli.co.za/fontes/smart/tntnovelas.m3u8', category: 'Series', logo: `${LOGO_BASE}/tnt-novelas-br.png` },
    ...
    // === MUSICA ===
    { id: 'top-mix-gospel', name: 'TV Top Mix Gospel', url: 'https://video03.logicahost.com.br/topmixtv/topmixtv/chunklist_w1404821297.m3u8', category: 'Musica', logo: 'https://topmixtv.com.br/wp-content/uploads/2020/07/logo.png' },
    { id: 'retro-music-tv', name: 'Retro Music Television', url: 'https://stream.mediawork.cz/retrotv/smil:retrotv2.smil/playlist.m3u8', category: 'Musica', logo: 'https://retromusic.cz/images/retromusictelevision_logo2.png' },
    { id: 'kpop-tv', name: 'K-Pop Television', url: 'https://live20.bozztv.com/giatv/giatv-kpoptvplay/kpoptvplay/playlist.m3u8', category: 'Musica', logo: 'https://kpoptv.live/images/logo.png' },
];
